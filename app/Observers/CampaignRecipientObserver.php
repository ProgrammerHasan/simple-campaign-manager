...
{
    // ❌ এই পদ্ধতি বাস্তবে বড় সমস্যা তৈরি করে। কেন?

    /**
     * কেন Observer ব্যবহার করা উচিত নয় (ডিটেইল সহ):
     *
     ...
     *    এর ফলে কোড পড়া, বোঝা, maintain করা কঠিন হয়ে যায়।
     *
     *    ▶ Example:
     ...
     *
     *
     * 2. Uncontrolled Triggers (Testing / Seeding / Import এ সমস্যা):
     *    ------------------------------------------------------------
     ...
     *
     *    এটা production bug এর সবচেয়ে সাধারণ কারণ দৃশ্যের পিছনে থাকে,
     *    কারণ observer ON থাকে কিন্তু developer সেটা খেয়াল করে না।
     *
     *
     ...
     *      - field normalize
     *
     *    কিন্তু email পাঠানো, payment নেয়া, workflow শুরু—এগুলো
     *    “Business Logic”
     *    → যা Service Layer বা Domain Layer এ থাকা উচিত।
     *
     *    Observer কে business rules দিলে architecture dirty হয়ে যায়।
     *
     *
     * 4. No Context Awareness (কোন পরিস্থিতিতে চলবে—বুঝে না):
     *    -----------------------------------------------------
     *    Observer জানে না:
     ...
     *
     *    Production-এ সমস্যার সময়:
     *      “ইমেইল কই থেকে dispatch হচ্ছে?” → খুঁজে পাওয়া কঠিন হয়ে যায়।
     *
     *
     ...
     *
     *
     * 7. Accidental Side Effects (Dangerous for Real Apps):
     *    --------------------------------------------------
     ...
     *
     * 🔥 Final Verdict:
     * Observer event গুলো “surprise side effects” তৈরি করে।
     * Business logic কখনোই observer-এ রাখা উচিত নয়।
     * এর ফলে আপনাকে পুরো অ্যাপের stability, predictability এবং maintenance ক্ষতিগ্রস্ত হয়।
     */
